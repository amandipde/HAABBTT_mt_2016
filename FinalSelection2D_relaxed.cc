	...
	for (int k=0; k<nbhist; ++k){
	    ...
	    if (tes==1 && gen_match_2==5){
	       if (k==0){ mytau*=0.988; mymet=mymet+(0.012/0.988)*mytau;}
            ...
            if (tes==1){
               if (k==8){ mymu*1.002;  mymet=mymet-(0.002/1.002)*mymu;}
               else if (k==9){ mymu*0.998;  mymet=mymet+(0.002/0.998)*mymu;}
...
//selection_1b = (mt1+mt2<80);
//bool selection_1b = (mt1<60 and mt12<70 and mt2<80 and pzeta>-90);
...
//selection_1b=true;
	    ...
	    //
	    //cout<<njets<<" "<<mjj<<endl;
	    //bool is_incl_2b=mbtt>=90 and nbtag>=1 and nbtagL<200 and selection_1b and njets>=2 and mjj>500;
	    //bool is_2b=mbtt<90 and nbtagL<200 and nbtag>=1 and selection_1b and njets>=2 and mjj>500;
...
//var_1b=TMass_F((mytau+mymu).Pt(),mymet.Pt(),(mytau+mymu).Px(),mymet.Px(),(mytau+mymu).Py(),mymet.Py());
//cout<<gen_match_2<<endl;
	    //************************* Fill histograms **********************
	    if (is_incl_2b){
